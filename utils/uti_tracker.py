...
def delete_invalid_skeletons_from_lists(skeletons_src):
    ...
    for skeleton in skeletons_src:
        ...
        if iValid_Joints >= 8 and fLength_of_Y >= 0.05 and iValid_Key_Joints >= 4:
...
class Tracker(object):
    ...
    def __init__(self, dist_thresh=0.2, max_humans=5):
        ''' 
        Arguments:
        ...
        self._ref_index_on_skeletons_x = 2
        self._ref_index_on_skeletons_y = 3
        self._dict_id2skeleton = {}
        self._cnt_humans = 0

    def _reset(self):
        '''Reset the dict that stiores the prev_skletons, if
            the skeletons was empty for a long time
        '''
        self._dict_id2skeleton = {}
        self._cnt_humans = 0
    ...
    def track(self, curr_skels):
        ...
        # if there are already skeletons in the dict, match them
        ...
        # if there are still no skeletons
        else:
            good_matches = []
    ...
    def _sort_skeletons_by_dist_to_center(self, skeletons_src):
        ...
        '''
        skeletons_src.sort(key = lambda P: (P[self._ref_index_on_skeletons_x] - self._ref_point[0])**2 +
                                     (P[self._ref_index_on_skeletons_y] - self._ref_point[1])**2)
...
if __name__=='__main__':
    ...
    testskls = [[0.7103658536585366, 0.5141304347826087, 0.9,
      0.9, 0.6097560975609756, 0.15896739130434784, 0.625, 0.26902173913043476, 0.7378048780487805, 
      ...
      0.10190217391304347, 0.6585365853658537, 0.08152173913043478, 0, 0], [0.7962962962962963, 0.12228260869565218, 0.5, 0.5, 0.6759259259259259, 
      0.17934782608695654, 0.6898148148148148, 0.29347826086956524, 0.8148148148148148, 0.4157608695652174,
       ...
       0.8194444444444444, 0.11005434782608697, 0.7407407407407407, 0.09375, 0, 0], [0.47685185185185186, 0.14266304347826086, 0.3,
        0.3, 0.35648148148148145, 0.14266304347826086, 0.4444444444444444, 0.27717391304347827, 
    ...
    # 23644
    test_skl_t2 = [[0.6481481481481481, 0.19565217391304346, 0.6157407407407407, 0.2282608695652174, 0.6018518518518519, 0.23233695652173914,
     0.5972222222222222, 0.28940217391304346, 0.6157407407407407, 0.34646739130434784, 0.6296296296296297, 0.2282608695652174, 0.6388888888888888,
      0.27717391304347827, 0.6481481481481481, 0.3342391304347826, 0.6064814814814815, 0.34239130434782605, 0.5972222222222222, 0.4402173913043479,
       0.5833333333333334, 0.5298913043478262, 0.6342592592592593, 0.3342391304347826, 0.6111111111111112, 0.4361413043478261, 0.5879629629629629,
        0.5258152173913043, 0.6435185185185185, 0.1875, 0.6435185185185185, 0.1875, 0.6203703703703703, 0.19157608695652176, 0, 0],
        [0.8425925925925926, 0.17527173913043478, 0.7268518518518519, 0.17527173913043478, 0.7268518518518519, 
    ...
    # 23645
    test_skl_t3 = [[0.6481481481481481, 0.19565217391304346, 0.6157407407407407, 0.2282608695652174, 0.6018518518518519, 0.2282608695652174, 
    0.5972222222222222, 0.28940217391304346, 0.6157407407407407, 0.34646739130434784, 0.6296296296296297, 0.2282608695652174, 0.6388888888888888, 
    0.27717391304347827, 0.6481481481481481, 0.28940217391304346, 0.6064814814814815, 0.34239130434782605, 0.5972222222222222, 0.4402173913043479, 
    0.5879629629629629, 0.5298913043478262, 0.6342592592592593, 0.3342391304347826, 0.6064814814814815, 0.4361413043478261, 0.5879629629629629, 
    0.5258152173913043, 0.6435185185185185, 0.1875, 0.6435185185185185, 0.1875, 0.6203703703703703, 0.19157608695652176, 0, 0]]
    
    #23646
    test_skl_t4 = [[0.6481481481481481, 0.19565217391304346, 0.6157407407407407, 0.2282608695652174, 0.6018518518518519, 0.2282608695652174, 0.5972222222222222, 0.28940217391304346, 0.6157407407407407, 0.34646739130434784, 0.6296296296296297, 0.2282608695652174, 0.6388888888888888, 0.27717391304347827, 0.6481481481481481, 0.3220108695652174, 0.6064814814814815, 0.3383152173913043, 0.5972222222222222, 0.4402173913043479, 0.5879629629629629, 0.5298913043478262, 0.6342592592592593, 0.3342391304347826, 0.6064814814814815, 0.4361413043478261, 0.5879629629629629, 0.5298913043478262, 0.6435185185185185, 0.1875, 0.6435185185185185, 0.1875, 0.6203703703703703, 0.19157608695652176, 0, 0]]
